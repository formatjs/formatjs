...
import {SegmentationRules} from '#formatjs_generated/packages/generated/unicode/cldr-segmentation-rules.js'
import {
  isSurrogate,
  replaceVariables,
} from '#packages/intl-segmenter/segmentation-utils.js'
