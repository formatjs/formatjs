...
import { rawDataToInternalSlots, extractILD, extractUnitPattern, extractDecimalPattern, extractPercentPattern, extractCurrencyPattern } from '../src/data';
...
new Suite('UnifiedNumberFormat data processing', {
  ...
  .add('extractILD', () => extractILD(unpackedData.en.units,
  unpackedData.en.currencies,
  unpackedData.en.numbers,
  'latn'))
  .add('extractUnitPattern', () => extractUnitPattern(
    unpackedData.en.numbers,
    unpackedData.en.units,
  ))
  .add('extractDecimalPattern', () => extractDecimalPattern(unpackedData.en.numbers,))
  .add('extractPercentPattern', () => extractPercentPattern(unpackedData.en.numbers))
  .add('extractCurrencyPattern', () => extractCurrencyPattern(unpackedData.en.numbers, unpackedData.en.currencies))
  .add('preprocessing', () =>
