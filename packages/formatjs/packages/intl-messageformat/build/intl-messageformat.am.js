...
IntlMessageFormat.__addLocaleData({locale:"am", messageformat:{pluralFunction:function (n) { var i=Math.floor(Math.abs(n));n=Math.floor(n);if(i===0||n===1)return"one";return"other"; }}});