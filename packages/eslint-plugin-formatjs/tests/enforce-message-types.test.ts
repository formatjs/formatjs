...
import type {TypedMessageDescriptor} from "react-intl"; export const messages: { "count": TypedMessageDescriptor<{ "n": number | bigint }> } = defineMessages<{ "count": { "n": number | bigint } }>({count: {defaultMessage: '{n, number}'}}, {typed: true})`,
    ...
    },
    {
      ...
      output: `import {defineMessages as dm, type MessageDescriptor as MD, type TypedMessageDescriptor as TD} from '@formatjs/intl'; const messages: { readonly "count": TD<{ "n": number | bigint }> } = dm<{ "count": { "n": number | bigint } }>({count: {defaultMessage: '{n, number}'}}, {typed: true})`,
      errors: [{messageId: 'contract'}],
    },
    {
      filename: 'test.ts',
      ...
      output: `import {defineMessages, type MessageDescriptor, type TypedMessageDescriptor} from 'react-intl'; const messages: { readonly "count": TypedMessageDescriptor<{ "n": number | bigint }> } = defineMessages<{ "count": { "n": number | bigint } }>({count: {defaultMessage: '{n, number}'}}, {typed: true})`,
      errors: [{messageId: 'contract'}],
    },
    {
      filename: 'test.ts',
