...
it('formats decimal', () => {
  const data = require('../tests-locale-data/ja.json').data.ja;
...
it('formats percentage with compact display', () => {
  ...
  const data = require('../tests-locale-data/en.json').data.en;
...
it('formats currency where the number precedes the symbol', () => {
  ...
  const data = require('../tests-locale-data/ar-SS.json').data['ar-SS'];
...
it('respects currencyAfter insertion rule', () => {
  const data = require('../tests-locale-data/bn.json').data.bn;
...
it('formats currency name pattern with currency before number', () => {
  ...
  const data = require('../tests-locale-data/sw.json').data.sw;
...
it('determines plurality of unit based on mantissa of the scientific notation', () => {
  ...
  const data = require('../tests-locale-data/en-BS.json').data['en-BS'];
...
it('uses decimal compact pattern to format currency with currencyDisplay === "name"', () => {
  ...
  const data = require('../tests-locale-data/de.json').data.de;
