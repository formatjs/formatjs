...
def jest_test_v2(name, srcs = [], deps = [], size = "small", tsconfig = "//:tsconfig.es6", jest_config = "//:jest.config", node_modules = "//:node_modules", snapshots = [], flaky = False, tags = [], no_copy_to_bin = [], **kwargs):
    """A macro around the autogenerated jest_test rule.
