...
Calendar package payloads are generated by `calendar_package.bzl`: entrypoint,
README, license, manifest, and locale modules. Each package keeps only a small
`BUILD.bazel` version declaration and synced `package.json` for workspace and
