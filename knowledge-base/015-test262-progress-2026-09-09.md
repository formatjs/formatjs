...
For current results, see the [2026-09-11 update](./015b-test262-progress-2026-09-11.md).
The counts below preserve the September 9 snapshot.

The twelve polyfills execute every test in their upstream Test262 directories,
both independently and with all twelve installed. Each mode recorded
...
The [categorized testcase inventory](https://github.com/formatjs/formatjs/blob/f7e0d1a3adbb357dcfb046cdfb4141a32eef41e7/knowledge-base/015a-test262-deferred-cases.json) covers
