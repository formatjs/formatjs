...
Total: 2,498 executions, 2,270 polyfill passes, 228 polyfill failures. The native
control fails 86 executions; 44 failing cases overlap. Overlap does not prove
a polyfill is correct: each failure still needs comparison with the selected
spec and test's feature metadata.

Combined: 2,498 executions, 2,268 passes, 230 failures.
