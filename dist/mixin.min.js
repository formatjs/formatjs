...
var v=t,w={dateTimeFormats:{},numberFormats:{},messageFormats:{}},x={contextTypes:{locales:React.PropTypes.oneOfType([React.PropTypes.string,React.PropTypes.array]),formats:React.PropTypes.object},childContextTypes:{locales:React.PropTypes.oneOfType([React.PropTypes.string,React.PropTypes.array]),formats:React.PropTypes.object},propsTypes:{locales:React.PropTypes.oneOfType([React.PropTypes.string,React.PropTypes.array]),formats:React.PropTypes.object},getChildContext:function(){var a=Object.create(this.context);return this.props.locales&&(a.locales=this.props.locales),this.props.formats&&(a.formats=this.props.formats),a},intlDate:function(a,b){var c=this.props.locales||this.context.locales,d=this.props.formats||this.context.formats;if(a=new Date(a),!a||!a.getTime())throw new TypeError("A date must be provided.");if(b&&"string"==typeof b)try{b=d.date[b]}catch(e){throw new ReferenceError("No date format named: "+b)}return h(c,b).format(a)},intlTime:function(a,b){var c=this.props.formats||this.context.formats;if(b&&"string"==typeof b)try{b=c.time[b]}catch(d){throw new ReferenceError("No time format named: "+b)}return this.intlDate(a,b)},intlNumber:function(a,b){var c=this.props.locales||this.context.locales,d=this.props.formats||this.context.formats;if("number"!=typeof a)throw new TypeError("A number must be provided.");if(b&&"string"==typeof b)try{b=d.number[b]}catch(e){throw new ReferenceError("No number format named: "+b)}return i(c,b).format(a)},intlMessage:function(a,b){var c=this.props.locales||this.context.locales,d=this.props.formats||this.context.formats;return"function"==typeof a?a(b):("string"==typeof a&&(a=j(a,c,d)),a.format(b))}};this.ReactIntlMixin=x}).call(this);