...
KARMA_TESTS = [
    ...
    "//packages/intl-durationformat:bundled-karma-tests",
...
multirun(
    ...
    commands = [
        ...
        "//packages/intl-durationformat:test262-main",
        "//packages/intl-durationformat:generated-test-files",
...
multirun(
    ...
    commands = [
        ...
        "//packages/intl-durationformat:generated-files",
