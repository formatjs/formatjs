...
## What's Changed
* chore(deps): update rust crate indexmap to v2.13.0 by @renovate[bot] in https://github.com/formatjs/formatjs/pull/5854
* chore(deps): update github artifact actions (major) by @renovate[bot] in https://github.com/formatjs/formatjs/pull/5827
* feat(@formatjs/intl-segmenter): improve Unicode 17.0 Format/Extend transparency and upgrade deps by @longlho in https://github.com/formatjs/formatjs/pull/5862
* feat(eslint-plugin-formatjs): replace unicode-emoji-utils with native implementation by @longlho in https://github.com/formatjs/formatjs/pull/5865
* fix(eslint-plugin-formatjs): remove obsolete @types/eslint by @andersk in https://github.com/formatjs/formatjs/pull/5884
* docs: make dark colour scheme default by @samrobbins85 in https://github.com/formatjs/formatjs/pull/5895
* build: fix release workflow name by @longlho in https://github.com/formatjs/formatjs/pull/5934
* test(@formatjs/intl-datetimeformat): add test for #4270 by @longlho in https://github.com/formatjs/formatjs/pull/5931
* chore(deps): update dependency @glimmer/syntax to v0.95.0 by @renovate[bot] in https://github.com/formatjs/formatjs/pull/5951
* chore(deps): update dependency bazel to v9 by @renovate[bot] in https://github.com/formatjs/formatjs/pull/5984
* chore(deps): update dependency lodash-es to v4.17.23 [security] by @renovate[bot] in https://github.com/formatjs/formatjs/pull/5989
* fix(formatjs_cli): fix format extraction bug by @longlho in https://github.com/formatjs/formatjs/pull/5995
...
## New Contributors
* @samrobbins85 made their first contribution in https://github.com/formatjs/formatjs/pull/5895
