...
interface DialogHeaderComponent {
  (props: React.HTMLAttributes<HTMLDivElement>): React.JSX.Element
  displayName: string
}

const DialogHeader: DialogHeaderComponent = Object.assign(
  ({
    className,
    ...props
...
interface DialogFooterComponent {
  (props: React.HTMLAttributes<HTMLDivElement>): React.JSX.Element
  displayName: string
}

const DialogFooter: DialogFooterComponent = Object.assign(
  ({
    className,
    ...props
  }: React.HTMLAttributes<HTMLDivElement>): React.JSX.Element => (
