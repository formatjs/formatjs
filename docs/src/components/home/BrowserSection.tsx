  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 md:py-16">
      <h2 className="text-xl md:text-2xl font-semibold mb-4">
        Runs in the browser, Node.js, and Rust.
      </h2>
      <p className="text-sm md:text-base text-muted-foreground mb-4">
        ...
        client-side of their apps. FormatJS also provides native Rust
        implementations for high-performance parsing and formatting.
      </p>
      <div className="flex flex-wrap gap-4 md:gap-8 my-8 items-center">
        ...
        <img src="/img/rust.svg" alt="Rust" className="h-10 md:h-[60px]" />
      </div>
    </div>
  )
}
