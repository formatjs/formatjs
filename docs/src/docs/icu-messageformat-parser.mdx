...
The parser detects Unicode property escape support at startup and falls back to
generated character ranges when unavailable. No regex polyfill is required for
identifier parsing.
