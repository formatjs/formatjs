...
The Node.js CLI always fails on input read errors, including `EMFILE`, and leaves
...
Node.js extraction bounds concurrent file reads to the available CPU count,
