...
- **📊 Number Skeleton Parsing**: Parse ICU number skeletons like `::currency/USD compact-short`
- **📅 Date/Time Skeleton Parsing**: Parse date/time skeletons like `yMMMd`
- **🚀 High Performance**: Native Rust implementation optimized for speed
- **🔒 Type Safe**: Strongly-typed options with comprehensive validation
...
- [Source Code](https://github.com/formatjs/formatjs/tree/main/rust/icu_skeleton_parser)
