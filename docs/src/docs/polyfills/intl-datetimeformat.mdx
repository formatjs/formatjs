...
await Promise.all([
  ...
  import('@formatjs/intl-datetimeformat/calendar-data/hebrew.js'),
  import('@formatjs/intl-datetimeformat/calendar-data/hebrew/en.js'),
])
...
Use `calendar-data/<calendar>.js` and
`calendar-data/<calendar>/<locale>.js` for each calendar and locale you need.
...
```js
import {DateTimeFormat} from '@formatjs/intl-datetimeformat'
import hebrew from '@formatjs/intl-datetimeformat/calendar-data/hebrew.js'
