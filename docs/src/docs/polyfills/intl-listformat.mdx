...
Loading a locale also registers its CLDR default-content variants. For example,
English data supports `en-US`. Explicitly loaded regional data remains distinct
from its language's data, regardless of load order.
