...
Global import does not provide type declarations, therefore in Typescript codebases it's recommended to use ES Modules import instead. If you want to use global imports, you can include type declarations files (.d.ts files) manually in your project.
</Admonition>
