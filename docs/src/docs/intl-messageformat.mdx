...
The contract works with both message strings and parsed ASTs. TypeScript does
not verify that a handwritten contract matches the message. Keep the contract
in sync with the ICU source.
